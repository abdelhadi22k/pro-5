  ...
  return (
    <section className="FAQs" id='FAQs'>
      <Container className="FAQsContainer">
        <div>
          <h1 className="minTitle">FAQs</h1>
          <p className="minParagraph">
            {" "}
            Common questions on the minds of customers and people interested in our services
          </p>
        </div>
        <>
          <Accordion defaultActiveKey="0">
            <Accordion.Item eventKey="0">
              ...
              <Accordion.Body>
              We seek to provide high-quality services to our customers and achieve their complete satisfaction. 
              Therefore, we have established these policies to ensure smooth and efficient workflow, and to preserve 
            ...
            <Accordion.Item eventKey="1">
              ...
              <Accordion.Body>
                1 The customer can renew the service under annual, semi-annual, quarterly or monthly contracts.
                <br />
                2 The cost of renewal is specified in the contract
                <br />
                3 The customer must provide written notice of his desire to renew his website 14 days before the expiration of the current contract.
                <br />
                4 If the customer does not provide notice, the services will be considered expired.
              </Accordion.Body>
            </Accordion.Item>
            ...
            <Accordion.Item eventKey="5">
              ...
              <Accordion.Body>
                ...
                <br />
                4 The client is deemed to have surrendered his rights to
            ...
            <Accordion.Item eventKey="6">
              ...
              <Accordion.Body>
                ...
                days.
                <br />
                3 If the client does not provide the required information
            ...
            <Accordion.Item eventKey="7">
              ...
              <Accordion.Body>
                ...
                within 5 days of receipt of the work.
                <br />
                4 In cases of renewal (see the services renewal policy),
            ...
            <div className="Accordion">
              <h1 className="minTitle">Still have questions?</h1>
              <p className="minParagraph">
